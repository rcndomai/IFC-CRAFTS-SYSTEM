...
public class editorderitem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        productID.setFont(new java.awt.Font("Baskerville", 0, 24)); // NOI18N
        productID.setBorder(null);
        productID.addActionListener(this::productIDActionPerformed);
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {                                     
        ...
        java.sql.PreparedStatement checkOrder = conn.prepareStatement(checkOrderSQL);
        ...
        java.sql.PreparedStatement checkProduct = conn.prepareStatement(checkProductSQL);

        checkProduct.setInt(1, productIDValue);
        java.sql.ResultSet productRS = checkProduct.executeQuery();
        ...
        java.sql.PreparedStatement duplicateStmt = conn.prepareStatement(duplicateSQL);

        duplicateStmt.setInt(1, orderIDValue);
        duplicateStmt.setInt(2, productIDValue);

        java.sql.ResultSet duplicateRS = duplicateStmt.executeQuery();
        ...
        java.sql.PreparedStatement pst = conn.prepareStatement(insertSQL);
